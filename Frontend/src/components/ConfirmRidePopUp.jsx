      ...
      <div className="flex items-center justify-between bg-yellow-400 p-3 rounded-lg mt-4">
        <div className="flex items-center gap-3 ">
          <img
            ...
            alt=""
          />
          <h2 className="text-xl text-font-medium capitalize">
      ...
      <div className="flex flex-col gap-2 justify-between items-center">
        ...
        <div className="mt-6 w-full">
          <form onSubmit={submitHandler}>
            ...
            />
            <button className="w-full flex items-center justify-center mt-5 bg-green-600 text-white font-semibold p-2 rounded-lg">
              Confirm
            </button>
            <button
              onClick={() => {
